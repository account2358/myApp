...
wx.ready(function () {
  ...
  document.querySelector('#chooseWXPay').onclick = function () {
    ...
    wx.chooseWXPay({
      timestamp: 1514390302,
      nonceStr: '5f39b7eb-29fd-4c4a-9ecd-ff38a25c90c5',
      package: 'prepay_id=wx201712272349177aaedb32190868881333',
      signType: 'MD5', // 注意：新版支付接口使用 MD5 加密
      paySign: 'BBBE741C4430801131F6A46DEDB58FB6'
    });
  };
